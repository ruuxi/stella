...
Given a skill's markdown content and directory name, output ONLY valid YAML with these fields:

id: <use the directory name exactly as provided>
name: "<Human readable title>"
description: "<1-2 sentence summary of what this skill helps an AI assistant do>"
