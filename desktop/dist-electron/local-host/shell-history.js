...
import os from "os";
const log = (...args) => console.log("[shell-history]", ...args);
// ---------------------------------------------------------------------------
// Platform Paths
// ---------------------------------------------------------------------------
...
const extractCdPath = (line) => {
    ...
    if (cdPath.length < 5 && !path.isAbsolute(cdPath))
        return null;
    return cdPath;
};
// ---------------------------------------------------------------------------
// Main Analysis
// ---------------------------------------------------------------------------
export const analyzeShellHistory = async () => {
 ...
 */
export const formatShellAnalysisForSynthesis = (data) => {
    const sections = ["## Shell History"];
