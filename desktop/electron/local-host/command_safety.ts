...
const UNSAFE_SKILL_PATTERNS: UnsafePattern[] = [
 ...
 */
export const validateSkillContent = (content: string): SkillValidationResult => {
  const strippedContent = stripCodeBlocks(content);
  const issues: Array<{ category: string; description: string }> = [];
