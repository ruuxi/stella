...
export const createRuntimeDaemonServer = (peer: JsonRpcPeer) => {
  ...
  const workerMethodMap: Record<(typeof workerProxyMethods)[number], string> = {
    ...
    [METHOD_NAMES.LOCAL_CHAT_GET_OR_CREATE_DEFAULT]:
      METHOD_NAMES.LOCAL_CHAT_GET_OR_CREATE_DEFAULT,
    [METHOD_NAMES.LOCAL_CHAT_LIST_EVENTS]: METHOD_NAMES.LOCAL_CHAT_LIST_EVENTS,
    [METHOD_NAMES.LOCAL_CHAT_GET_EVENT_COUNT]: METHOD_NAMES.LOCAL_CHAT_GET_EVENT_COUNT,
    [METHOD_NAMES.LOCAL_CHAT_APPEND_EVENT]: METHOD_NAMES.LOCAL_CHAT_APPEND_EVENT,
    [METHOD_NAMES.LOCAL_CHAT_LIST_SYNC_MESSAGES]: METHOD_NAMES.LOCAL_CHAT_LIST_SYNC_MESSAGES,
    [METHOD_NAMES.LOCAL_CHAT_GET_SYNC_CHECKPOINT]: METHOD_NAMES.LOCAL_CHAT_GET_SYNC_CHECKPOINT,
    [METHOD_NAMES.LOCAL_CHAT_SET_SYNC_CHECKPOINT]: METHOD_NAMES.LOCAL_CHAT_SET_SYNC_CHECKPOINT,
    [METHOD_NAMES.STORE_MODS_LIST_FEATURES]: METHOD_NAMES.STORE_MODS_LIST_FEATURES,
    [METHOD_NAMES.STORE_MODS_LIST_BATCHES]: METHOD_NAMES.STORE_MODS_LIST_BATCHES,
    [METHOD_NAMES.STORE_MODS_CREATE_RELEASE_DRAFT]: METHOD_NAMES.STORE_MODS_CREATE_RELEASE_DRAFT,
    [METHOD_NAMES.STORE_MODS_LIST_INSTALLED]: METHOD_NAMES.STORE_MODS_LIST_INSTALLED,
    ...
    [METHOD_NAMES.SCHEDULE_LIST_CRON_JOBS]: METHOD_NAMES.SCHEDULE_LIST_CRON_JOBS,
    [METHOD_NAMES.SCHEDULE_LIST_HEARTBEATS]: METHOD_NAMES.SCHEDULE_LIST_HEARTBEATS,
    [METHOD_NAMES.SCHEDULE_LIST_EVENTS]: METHOD_NAMES.SCHEDULE_LIST_EVENTS,
    [METHOD_NAMES.SCHEDULE_GET_EVENT_COUNT]: METHOD_NAMES.SCHEDULE_GET_EVENT_COUNT,
    [METHOD_NAMES.SOCIAL_SESSIONS_GET_STATUS]: METHOD_NAMES.SOCIAL_SESSIONS_GET_STATUS,
    ...
    [METHOD_NAMES.SHELL_KILL_BY_PORT]: METHOD_NAMES.SHELL_KILL_BY_PORT,
  };
