...
```
<data source> [chart type] [additional instructions]
```
...
```
Here's our NPS data by product: [pastes data]. Create a horizontal bar chart ranking products by score.
```

```
Query the orders table and create a heatmap of order volume by day-of-week and hour
```
