...
```
Review this quarterly revenue analysis before I send it to the exec team: [analysis]
```
...
```
Here's a SQL query and its results for our conversion funnel. Does the logic look right? [query + results]
```
