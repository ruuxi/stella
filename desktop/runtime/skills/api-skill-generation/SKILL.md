...
When the agent returns an API map from investigation, convert it into a persistent skill.

## Workflow
1. agent discovers APIs via network interception and returns structured API map JSON.
