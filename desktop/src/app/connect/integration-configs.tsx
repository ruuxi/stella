...
export const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    botLink: (() => {
      ...
      const redirectUri = `${siteUrl}/api/slack/oauth_callback`;
      return `https://slack.com/oauth/v2/authorize?client_id=10408521461909.10415731582148&scope=chat:write,im:history,im:read,im:write&redirect_uri=${encodeURIComponent(redirectUri)}`;
    })(),
  ...
  {
    provider: "linq",
    displayName: "Text Stella (iMessage/SMS)",
    type: "bot",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor">
