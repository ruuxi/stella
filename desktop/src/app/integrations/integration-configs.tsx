...
export type IntegrationGroup = "messaging" | "bridges";
...
export const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24">
        <path fill="#3A76F0" d="M12 1.5C6.202 1.5 1.5 6.202 1.5 12c0 1.94.532 3.756 1.453 5.312l-.98 3.578a.75.75 0 0 0 .918.918l3.578-.98A10.453 10.453 0 0 0 12 22.5c5.798 0 10.5-4.702 10.5-10.5S17.798 1.5 12 1.5z" />
      </svg>
    ),
