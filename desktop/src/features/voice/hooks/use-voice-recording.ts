...
import type { StreamingTranscribeSession } from "@/features/voice/services/speech-to-text";
import {
...
const loadSpeechToTextModule = () => {
  if (!speechToTextModulePromise) {
    speechToTextModulePromise = import("@/features/voice/services/speech-to-text");
  }
