...
const css = `
  .wx-root { position: relative; padding: 24px; display: flex; flex-direction: column; gap: 20px; height: 100%; font-family: var(--font-family-sans, "Plus Jakarta Sans", sans-serif); color: var(--foreground); background: transparent; overflow: hidden; }
