...
stella-browser --cdp "wss://browser-service.com/cdp?token=..." snapshot

# Works with any CDP-compatible service
stella-browser --cdp "ws://localhost:9222/devtools/browser/abc123" open example.com`} />
...
stella-browser open https://example.com`} />
        <p>The <code>-p</code> flag takes precedence over <code>STELLA_BROWSER_PROVIDER</code>.</p>
      </div>
    </div>
  );
}
