  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="prose">
        ...
        <CodeBlock code={`stella-browser snapshot                    # Full accessibility tree
...
stella-browser snapshot -c                 # Compact (remove empty elements)
...
stella-browser snapshot -i -c -d 5         # Combine options`} />
        ...
        <CodeBlock code={`stella-browser snapshot -i -C
# Output includes:
# @e1 [button] "Submit"
# @e2 [link] "Learn more"
...
# @e4 [clickable] "Card" [cursor:pointer]`} />
        ...
        <CodeBlock code={`stella-browser snapshot -i
# Output:
...
# @e4 [link] "Learn more"`} />
        ...
        <CodeBlock code={`stella-browser click @e2      # Click the Submit button
stella-browser fill @e3 "a@b.com"  # Fill the email input
stella-browser get text @e1        # Get heading text`} />
        ...
        <CodeBlock code={`stella-browser click @e4      # Navigates to new page
stella-browser snapshot -i    # Get fresh refs
