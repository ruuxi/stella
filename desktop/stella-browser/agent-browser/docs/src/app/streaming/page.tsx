  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="prose">
        ...
        <p>
          Set the <code>STELLA_BROWSER_STREAM_PORT</code> environment variable to start
          a WebSocket server:
        </p>
        <CodeBlock code={`STELLA_BROWSER_STREAM_PORT=9223 stella-browser open example.com`} />
...
// Multi-touch (pinch zoom)
{
  ...
  "touchPoints": [
    ...
    { "x": 200, "y": 200, "id": 1 }
        ...
        <CodeBlock code={`import { BrowserManager } from 'stella-browser';
