...
fn get_auth_dir() -> PathBuf {
    crate::connection::get_storage_root_dir().join("auth")
}
...
/// Storage root/.encryption-key file (matching the Node.js implementation).
...
fn ensure_encryption_key() -> Result<Vec<u8>, String> {
    ...
    eprintln!(
        "[stella-browser] Auto-generated encryption key at {} -- back up this file or set {}",
        key_file.display(),
        ENCRYPTION_KEY_ENV
    );
