...
stella-browser open https://example.com`} />
          ...
          <li>
            ...
            <CodeBlock code={`stella-browser --ignore-https-errors open https://localhost:3000`} />
          </li>
          <li>
            ...
            <CodeBlock code={`stella-browser cookies set session_id "abc123" --url https://app.example.com --httpOnly --secure
stella-browser cookies set token "xyz" --domain .example.com --path /api --expires 1735689600`} />
          </li>
        </ul>
...
stella-browser open https://example.com`} />
          ...
          <li>
            ...
            <CodeBlock code={`stella-browser --profile ~/.myapp-profile open myapp.com
# Login persists across restarts`} />
          </li>
          <li>
            <strong>Remote CDP WebSocket URLs</strong> - Connect to remote browser services via WebSocket
            <CodeBlock code={`stella-browser --cdp "wss://browser-service.com/cdp?token=..." snapshot`} />
          </li>
          <li>
            <strong><code>download</code> command</strong> - Trigger downloads and wait for completion
            <CodeBlock code={`stella-browser download @e1 ./file.pdf
stella-browser wait --download ./output.zip --timeout 30000`} />
          </li>
          <li>
            <strong>Browser launch configuration</strong> - Fine-grained control over browser startup
            <CodeBlock code={`stella-browser --args "--disable-gpu,--no-sandbox" open example.com
stella-browser --user-agent "Custom UA" open example.com
stella-browser --proxy-bypass "localhost,*.internal" open example.com`} />
          </li>
          <li>
        ...
        <ul>
          ...
          <li>Fixed socket file location (uses <code>~/.stella-browser</code> instead of TMPDIR)</li>
        ...
        <ul>
          <li>
            ...
            <CodeBlock code={`stella-browser record start ./demo.webm
...
stella-browser record stop`} />
          ...
          <li>
            ...
            <CodeBlock code={`stella-browser connect 9222
stella-browser snapshot  # No --cdp needed after connect`} />
          </li>
          <li>
            <strong><code>--proxy</code> flag</strong> - Configure browser proxy with optional authentication
            <CodeBlock code="stella-browser --proxy http://user:pass@proxy.com:8080 open example.com" />
          </li>
          <li>
            <strong><code>get styles</code> command</strong> - Extract computed styles from elements
            <CodeBlock code={`stella-browser get styles "button"`} />
          </li>
          <li>
        ...
        <ul>
          ...
          <li>Respect <code>STELLA_BROWSER_HEADED</code> environment variable</li>
