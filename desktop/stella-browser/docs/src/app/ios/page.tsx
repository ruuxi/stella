...
appium driver install xcuitest`}
        ...
        <CodeBlock
          code={`stella-browser device list
...
stella-browser -p ios swipe down
stella-browser -p ios swipe left
stella-browser -p ios swipe right

# Swipe with distance (pixels)
stella-browser -p ios swipe up 500
...
stella-browser -p ios tap @e1`}
        ...
        <CodeBlock
          code={`export STELLA_BROWSER_PROVIDER=ios
...
stella-browser tap @e1`}
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                <code>STELLA_BROWSER_PROVIDER</code>
              </td>
              <td>
            ...
            <tr>
              <td>
                <code>STELLA_BROWSER_IOS_DEVICE</code>
              </td>
              <td>Device name (e.g., &quot;iPhone 16 Pro&quot;)</td>
            </tr>
            <tr>
              <td>
                <code>STELLA_BROWSER_IOS_UDID</code>
              </td>
...
open WebDriverAgent.xcodeproj`}
        ...
        <h3>3. Use with stella-browser</h3>
        <CodeBlock
...
appium --version`}
        ...
        <p>
          ...
          ensure it works, then retry with stella-browser.
        </p>
      </div>
    </div>
  );
