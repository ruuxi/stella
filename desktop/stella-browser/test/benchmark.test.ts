 ...
 *      STELLA_BROWSER_USER_BROWSER=1 STELLA_BROWSER_HEADED=1 node dist/daemon.js
...
function getPortFile(): string {
  const socketDir = process.env.STELLA_BROWSER_SOCKET_DIR
    || path.join(os.homedir(), '.stella-browser');
