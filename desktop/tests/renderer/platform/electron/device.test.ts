...
describe("device service", () => {
  ...
  describe("getOrCreateDeviceId", () => {
    it("returns cached id from electron API when available", async () => {
      ...
      const { getOrCreateDeviceId } = await import("../../../../src/platform/electron/device");
  ...
  describe("getCachedDeviceId", () => {
    it("returns null when nothing is cached or stored", async () => {
      const { getCachedDeviceId } = await import("../../../../src/platform/electron/device");
  ...
  describe("configurePiRuntime", () => {
    it("does nothing when electron API is absent", async () => {
      const { configurePiRuntime } = await import("../../../../src/platform/electron/device");
      // Should not throw
