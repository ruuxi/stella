...
import { IOSManager } from '../../stella-browser/src/ios-manager.js';

const mockSimctlDevices = {
  'iOS 18.0': [
    {
      name: 'iPhone 16 Pro',
      udid: 'TEST-UDID-1234',
...
describe('IOSManager', () => {
  ...
  beforeEach(() => {
    ...
    (manager as unknown as { simctl: { getDevices: () => Promise<typeof mockSimctlDevices> } }).simctl = {
      getDevices: vi.fn().mockResolvedValue(mockSimctlDevices),
    };
  });
