...
export const createExecCommandTool = (
  ...
  name: "exec_command",
  description:
    "Run a shell command in a PTY. Returns immediate output, or a session_id if the process is still running so you can poll/interact via write_stdin. Required: cmd. Git, Node.js (including npm/npx), Python, uv when managed, and Stella CLIs (stella-browser, stella-office, stella-computer, stella-connect, stella-media, stella-x-api) are auto-injected into PATH.",
  promptSnippet:
